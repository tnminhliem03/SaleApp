...
if __name__ == '__main__':
    with app.app_context():
        ...
        #
        # p6 = Product(name='Laptop Asus ROG Strix G18', price='70.990.000', category_id=2,
        ...
        #
        # p7 = Product(name='Laptop MSI Creator Z16', price='61.990.000', category_id=2,
        ...
        #
        # p8 = Product(name='Laptop LG Gram 2023', price='50.990.000', category_id=2,
        ...
        #
        # p9 = Product(name='Garmin Fenix 7X Pro Titanium', price='25.990.000', category_id=3,
        #               image='https://cdn.tgdd.vn/Products/Images/7077/308517/garmin-fenix-7x-pro-solar-titanium-xam-tb-1-600x600.jpg')
        #
        # p10 = Product(name='Apple Watch Ultra Titanium', price='23.990.000', category_id=3,
        #               image='https://cdn.tgdd.vn/Products/Images/7077/289814/apple-watch-ultra-alpine-m-cam-thumbnew-1-600x600.jpg')
        #
        # p11 = Product(name='Samsung Galaxy Watch5 Pro', price='11.990.000', category_id=3,
        ...
        #
        # p12 = Product(name='Huawei Watch Buds', price='10.990.000', category_id=3,
        ...
        #
        # p13 = Product(name='iPad Pro 2022 M2', price='38.990.000', category_id=4,
        ...
        #
        # p14 = Product(name='Samsung Galaxy Tab S9 Ultra', price='38.990.000', category_id=4,
        ...
        #
        # p15 = Product(name='OPPO Pad 2', price='14.990.000', category_id=4,
        #               image='https://cdn.tgdd.vn/Products/Images/522/303146/oppo-pad-2-thumb-600x600.jpeg')
        #
        # p16 = Product(name='Xiaomi Pad 6', price='10.490.000', category_id=4,
